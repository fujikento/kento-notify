...
git clone https://github.com/fujikento/kento-notify.git ~/kento-notify
cd ~/kento-notify
...
- **ヘルスチェック URL**: `http://localhost:5010/` (要確認)
- **ログ確認**: `docker compose logs -f`
- **バックアップ**: (未定 — 要設計)

## 関連リンク

- アップストリーム GitHub: https://github.com/novuhq/novu
- フォーク先 GitHub: https://github.com/fujikento/kento-notify
- ライセンス原文: https://github.com/novuhq/novu/blob/main/LICENSE
